				...
				<div>
					...
					<div className="p-5  ">
						...
						<div className="grid grid-cols-1 sm:grid-cols-2 gap-4 ">
							<div>
								<h1 className="text-xl py-2 text-green-500 text-center ">SEMESTRUL 7</h1>
								<div class="grid grid-cols-1 sm:grid-cols-1 gap-2">
									<div class="bg-slate-700 p-2 rounded-md border-2 border-green-800">
										IV/7_IMDCM_Limba engleza_43A_Duralia
									</div>
									<div class="bg-slate-700 p-2 rounded-md border-2 border-green-800">
										IV/7_IMDCM_Limba engleza_43B_Negoescu
									</div>
									<div class="bg-slate-700 p-2 rounded-md border-2 border-green-800">
										IV/7_IMDCM_Educatie fizica si sport
									</div>
									<div class="bg-slate-700 p-2 rounded-md border-2 border-green-800">
										IV/7_IMDCM_Practica de specialitate/stagiu
									</div>
									<div class="bg-slate-700 p-2 rounded-md border-2 border-green-800">
										IV/7_IMDCM_Dreptul tehnologiei informatiilor si comunicatiilor
									</div>
									<div class="bg-slate-700 p-2 rounded-md border-2 border-green-800">
										IV/7_IMDCM_Razboi electronic
									</div>
									<div class="bg-slate-700 p-2 rounded-md border-2 border-green-800">
										IV/7_IMDCM_Managementul retelelor integrate de campanie
									</div>
									<div class="bg-slate-700 p-2 rounded-md border-2 border-green-800">
										IV/7_IMDCM_Lb engleza_grupa A_Duralia
									</div>
									<div class="bg-slate-700 p-2 rounded-md border-2 border-green-800">
										IV/7_IMDCM_Opt_IMDCM_Limba engleza 43B_Negoescu
									</div>
									<div class="bg-slate-700 p-2 rounded-md border-2 border-green-800">
										IV/7_IMDCM_Opt 2 Sisteme radar
									</div>
								</div>
							</div>
							<div>
								<h1 className="text-xl py-2 text-green-500 text-center ">SEMESTRUL 8</h1>
								<div class="grid grid-cols-1 sm:grid-cols-1 gap-2">
									<div class="bg-slate-700 p-2 rounded-md border-2 border-green-800">
										IV/8_IMDCM_Educatie fizica si sport
									</div>
									<div class="bg-slate-700 p-2 rounded-md border-2 border-green-800">
										IV/8_IMDCM_Elaborarea proiectului de diploma
									</div>
									<div class="bg-slate-700 p-2 rounded-md border-2 border-green-800">
										IV/8_IMDCM_Managementul securitatii sistemelor de comunicatii
									</div>
									<div class="bg-slate-700 p-2 rounded-md border-2 border-green-800">
										IV/8_IMDCM_Pregatirea economiei nationale si a teritoriului pentru aparare
									</div>
									<div class="bg-slate-700 p-2 rounded-md border-2 border-green-800">
										IV/8_IMDCM_Practica pentru elaborarea lucrarii de licenta
									</div>
									<div class="bg-slate-700 p-2 rounded-md border-2 border-green-800">
										IV/8_IMDCM_Opt 1 Comunicare manageriala
									</div>
									<div class="bg-slate-700 p-2 rounded-md border-2 border-green-800">
										IV/8_IMDCM_Statistica economica
									</div>
									<div class="bg-slate-700 p-2 rounded-md border-2 border-green-800">
										IV/8_IMDCM_Managementul logisticii
									</div>
									<div class="bg-slate-700 p-2 rounded-md border-2 border-green-800">
										IV/8_IMDCM_Managementul resurselor umane
									</div>
								</div>
							</div>
						</div>
